...
| ID      | Prio | Epic            | User Story  | COS (Criteria of Satisfaction)  | Effort | Time | Status |
|---------|------|-----------------|-------------|---------------------------------|--------|------|--------|
| aikUs01 | 1    | UI/UX            | As a teacher, I want a clean and intuitive user interface, so I can navigate the application easily. | The UI must follow modern design principles and receive at least 80% positive usability feedback. | 8 | 1 
| aikUs02 | 3    | UI/UX            | As a user I want an accessible UI where I can adjust colors, font size and button size to my needs. | The UI must be adjustable by the user within a reasonable range, according to EU Accessibility regulations. | 13 | 6,5
